...
import {navigate, useLocationChange, usePath, useRoutes, useHash} from '../src'
import {LocationChangeSetFkt, RouteParams} from '../src/types'
...
describe('usePath', () => {
    ...
    test('does not include parent router base path', async () => {
        ...
        const routes = {
            ...
            '/about': () => <Route />,
            '/nested*': () => (
                <Harness basePath="/nested" routes={nestedRoutes} />
            ),
        }
